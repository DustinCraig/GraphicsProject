...
function load_shader(gl, type, source) {
  if (gl === null || gl === undefined) logger.error('gl context is null')
...
export class Shader {
  ...
  set_perspective_matrix(m) {
    this.gl.uniformMatrix4fv(this.uniform_location.perspective_matrix, false, new Float32Array(m))
  }
  ...
  set_camera_matrix(m) {
    this.gl.uniformMatrix4fv(this.uniform_location.camera_matrix, false, new Float32Array(m))
  ...
  set_clip_plane(x, y, z, w) {
    this.gl.uniform4f(this.uniform_location.clip_plane, x, y, z, w)
  }
  ...
  set_lightcolors(a, d, s) {
    ...
    if (a === null) this.gl.uniform4f(auniform, ...AMBIENT_COLOR)
    if (d === null) this.gl.uniform4f(duniform, ...DIFFUSE_COLOR)
    if (s === null) this.gl.uniform4f(suniform, ...SPECULAR_COLOR)
  ...
  add_texture(src, type, repeat = 0) {
    if (type === MODEL_TEXTURE || type === NORMAL_MAP) {
      ...
      image.src = src
      if (type === MODEL_TEXTURE) this.model_texture = texture
      ...
      const face_info = [
        {
          ...
          url: 'https://dustincraig.github.io/GraphicsProject/final_project_source/px.jpg',
        },
        {
          target: this.gl.TEXTURE_CUBE_MAP_NEGATIVE_X,
          url: 'https://dustincraig.github.io/GraphicsProject/final_project_source/nx.jpg',
        },
        {
          target: this.gl.TEXTURE_CUBE_MAP_POSITIVE_Y,
          url: 'hhttps://dustincraig.github.io/GraphicsProject/final_project_source/py.jpg',
        },
        {
          target: this.gl.TEXTURE_CUBE_MAP_NEGATIVE_Y,
          url: 'https://dustincraig.github.io/GraphicsProject/final_project_source/ny.jpg',
        },
        {
          target: this.gl.TEXTURE_CUBE_MAP_POSITIVE_Z,
          url: 'https://dustincraig.github.io/GraphicsProject/final_project_source/pz.jpg',
        },
        {
          target: this.gl.TEXTURE_CUBE_MAP_NEGATIVE_Z,
          url: 'https://dustincraig.github.io/GraphicsProject/final_project_source/nz.jpg',
        },
      ]
      let gl = this.gl
